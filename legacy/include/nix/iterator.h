...
#ifndef XR_COMMON_ITERATOR_T_H__
#define XR_COMMON_ITERATOR_T_H__
...
#define XR_ITERATOR_TRAITS_TYPEDEF(Traits)\
	typedef typename Traits::value_type value_type;\
	typedef typename Traits::difference_type difference_type;\
	typedef typename Traits::pointer pointer;\
	typedef typename Traits::reference reference;

#define XR_TYPE_ERASED_ITERATOR_TRAITS_TYPEDEF(Traits)\
	typedef typename Traits::iterator_category iterator_category;\
	XR_ITERATOR_TRAITS_TYPEDEF(Traits)

namespace xirang2 { namespace itr_{
	...
	{
		public:
			XR_TYPE_ERASED_ITERATOR_TRAITS_TYPEDEF(Traits);
		...
		: public imp_base<IteratorIFace, RealIterator>
	{
		public:
			...
			XR_TYPE_ERASED_ITERATOR_TRAITS_TYPEDEF(base_type);
		...
		: public imp_base<IteratorIFace, RealIterator>
	{
		public:
			...
			{	
				XR_PRE_CONDITION(dynamic_cast<const self_type*>(&rhs) != 0);
	...
	template<typename Base> class imp_wrap: public Base
	{
		public:
			...
			XR_TYPE_ERASED_ITERATOR_TRAITS_TYPEDEF(Base);
			...
			{
				using std::swap;
				XR_PRE_CONDITION(dynamic_cast<self_type*>(&rhs) != 0);
		...
		protected:
			...
			template<typename Iter> static typename Iter::difference_type 
				distance_(const Iter& lhs, const Iter& rhs){
					XR_PRE_CONDITION(lhs.valid());
					XR_PRE_CONDITION(rhs.valid());
...
#define XR_OUTPUT_ITERATOR_BASIC_METHOD_IMPS()\
...
#define XR_ITERATOR_BASIC_METHOD_IMPS()\
	XR_OUTPUT_ITERATOR_BASIC_METHOD_IMPS()\
...
struct select_second{
	...
	U& operator()(std::pair<const T, U>& p) const{ return p.second;}
	const U& operator()(const std::pair<const T, U>& p) const{ return p.second;}
};
...
class select_iterator 
{
	public:
		...
		template<typename Itr>
			select_iterator(Itr itr)
			: m_pos(itr), m_selector()
			{}
		template<typename Itr>
			select_iterator(Itr itr, Selector s)
...
template<typename RealIterator, typename Selector> select_iterator <RealIterator, Selector> 
	make_select_iterator(RealIterator itr, Selector sel){
		return select_iterator <RealIterator, Selector>(itr, sel);
	}
...
#undef XR_ITERATOR_TRAITS_TYPEDEF
#undef XR_TYPE_ERASED_ITERATOR_TRAITS_TYPEDEF
#undef XR_ITERATOR_BASIC_METHOD_IMPS
#undef XR_OUTPUT_ITERATOR_BASIC_METHOD_IMPS

#endif //end XR_COMMON_ITERATOR_T_H__
