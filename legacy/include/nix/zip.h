#ifndef XIRANG2_ZIP_H__
#define XIRANG2_ZIP_H__
...
namespace xirang2{ namespace zip{
	...
	XR_EXCEPTION_TYPE(data_corrupted_exception);
	...
	class XR_API reader{
		...
		public:
			xirang2::unique_ptr<zip_package_imp> m_imp;
	};

	class zip_package_writer_imp;
	class XR_API reader_writer{
		public:
			typedef package_iterator const_iterator;
			typedef const_iterator iterator;
	...
	XR_API extern iauto<io::read_map> open_raw(const file_header& fh);

}}

#endif //end XIRANG2_ZIP_H__
