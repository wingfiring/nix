#ifndef XR_COMMON_STRING_ALGO_UTF8_H__
#define XR_COMMON_STRING_ALGO_UTF8_H__
...
#endif
namespace xirang2{ namespace utf8 {

	XR_EXCEPTION_TYPE(unicode_out_range);
	XR_EXCEPTION_TYPE(invalid_utf8_code);
	XR_EXCEPTION_TYPE(no_enough_utf8_input);
	...
	template<typename InputIter, typename OutputIter>
		std::pair<InputIter, OutputIter> encode(range<InputIter> in, OutputIter out)
		{
			...
			for (; iin != in.end(); ++iin, ++out)
			{
				...
				{
					XR_THROW(unicode_out_range)("xirang2::utf8::encode");
				}
			}
...
#endif //end XR_COMMON_STRING_ALGO_UTF8_H__
