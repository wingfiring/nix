#ifndef XR_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
#define XR_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
...
namespace xirang2
{
	XR_EXCEPTION_TYPE(ext_heap_format_exception);
	...
	struct XR_API file_mapping_heap : ext_heap
	{
	public:
...
#endif //end XR_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
