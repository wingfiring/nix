#ifndef XIRANG2_MAP_H__
#define XIRANG2_MAP_H__
...
namespace xirang2{ namespace type{
	...
	{
	public:
		struct XR_API const_iterator : public std::iterator<std::random_access_iterator_tag, ConstCommonObject>
		{
