#ifndef XR_CONFIG_CONFIG_H__
#define XR_CONFIG_CONFIG_H__

namespace xirang2{	namespace os{
	struct os_tag{};
...
#ifdef xirang2
#pragma push_macro("xirang2")
#undef xirang2
#define NEED_POP_MACRO_XIRANG2
#endif

#define XIRANG2_OS_CONFIG <xirang2/config/os/OS_TYPE.h>
#define XIRANG2_COMPILER_CONFIG <xirang2/config/compiler/COMPILER_TYPE.h>
#define XIRANG2_STDLIB_CONFIG <xirang2/config/stdlib/STDLIB_TYPE.h>

#include XIRANG2_OS_CONFIG
#include XIRANG2_COMPILER_CONFIG
#include XIRANG2_STDLIB_CONFIG

#undef XIRANG2_OS_CONFIG
#undef XIRANG2_COMPILER_CONFIG
#undef XIRANG2_STDLIB_CONFIG

#ifdef NEED_POP_MACRO_XIRANG2
#pragma pop_macro("xirang2")
#undef NEED_POP_MACRO_XIRANG2
#endif

#if defined(XR_ABI_PREFIX) && defined(XR_ABI_SUFFIX) && !defined(XR_HAS_ABI_HEADERS)
#  define XR_HAS_ABI_HEADERS
#endif

#endif //end XR_CONFIG_CONFIG_H__
