...
BOOST_AUTO_TEST_CASE(path_normalize_case)
{
	...
	BOOST_CHECK(file_path(literal("/a/b.c/../../..")).str() == literal("/"));
	BOOST_CHECK(file_path(literal("//a/b.c/../../..")).str() == literal("//a"));
    BOOST_CHECK(file_path(literal("../a/")).str() == literal("../a"));
    BOOST_CHECK(file_path(literal("../a/..")).str() == literal(".."));
    BOOST_CHECK(file_path(literal("../..")).str() == literal("../.."));
    BOOST_CHECK(file_path(literal("/../..")).str() == literal("/"));
    BOOST_CHECK(file_path(literal("//..")).str() == literal("//.."));
    BOOST_CHECK(file_path(literal("//../..")).str() == literal("//.."));

    BOOST_CHECK(file_path("../..").is_normalized());
...
BOOST_AUTO_TEST_CASE(path_pop_back_case)
{
	file_path path_a_b_c("a/b/c"), expect_a_b("a/b"), expect_a("a");
	BOOST_CHECK(path_a_b_c.pop_back() == expect_a_b);
	BOOST_CHECK(path_a_b_c.pop_back(2) == expect_a);
}
BOOST_AUTO_TEST_CASE(path_pop_front_case)
{
	file_path path_a_b_c("a/b/c"), expect_b_c("b/c"), expect_c("c");
	BOOST_CHECK(path_a_b_c.pop_front() == expect_b_c);
	BOOST_CHECK(path_a_b_c.pop_front(2) == expect_c);
}
