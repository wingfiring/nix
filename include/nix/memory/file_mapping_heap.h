#ifndef NIX_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
#define NIX_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
...
namespace nix
{
	NIX_EXCEPTION_TYPE(ext_heap_format_exception);
	...
	class NIX_API file_mapping_heap : ext_heap
	{
	public:
...
#endif //end NIX_COMMON_UTILITY_FILE_MAPPING_HEAP_H__
